  ...
  const availableFields: FieldOption[] = useMemo(() => {
    ...
    const fields: FieldOption[] = [
      ...
      { key: "is_active", label: "Activo", type: "boolean" },
      {
        ...
        label: "Evento (Juez)",
        type: "select",
        options: (regionalFinalEvents || []).map((e) => ({ value: e.id, label: e.name })),
      },
      { key: "judge_onboarding_completed", label: "Onboarding Juez", type: "boolean" },
      {
        key: "judge_schedule_preference",
      ...
      { key: "judge_conflict_other_text", label: "Conflictos (Juez)", type: "text" },
      { key: "judge_comments", label: "Comentarios (Juez)", type: "text" },
