...
// TODO: Replace this placeholder with the actual event email content
function generateJudgeEventHtml(firstName: string, _eventId: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Información del evento — Technovation Girls Madrid</title>
</head>
    ...
    <tr>
      <td align="center" style="padding:40px 20px;">
        <table role="presentation" style="width:100%;max-width:600px;border-collapse:collapse;">
          <!-- Header -->
          <tr>
            <td style="background:linear-gradient(135deg,#d97706 0%,#b45309 100%);padding:30px;border-radius:16px 16px 0 0;text-align:center;">
          ...
          <tr>
            <td style="background-color:#ffffff;padding:40px;border-radius:0 0 16px 16px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
              ...
              <p style="margin:0 0 16px;color:#52525b;font-size:16px;line-height:1.6;">
                <!-- TODO: Add event-specific email content here -->
                Contenido del correo del evento pendiente de definir.
              </p>
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;">
                <tr>
                  <td align="center" style="padding:8px 0 32px;">
                    <a href="${PLATFORM_URL}"
                       style="display:inline-block;background:linear-gradient(135deg,#d97706 0%,#b45309 100%);color:#ffffff;text-decoration:none;padding:16px 32px;border-radius:12px;font-size:16px;font-weight:600;box-shadow:0 4px 14px rgba(217,119,6,0.4);">
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    //     subject: "Información del evento — Technovation Girls Madrid",
    //     htmlContent: html,
    //   }),
    // });
    //
    ...
    console.log(`Judge event email skipped for ${recipientEmail} (content not yet defined)`);
