...
function generateJudgeWelcomeHtml(firstName: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Tu perfil de juez está listo</title>
</head>
        ...
        <table role="presentation" style="width:100%;max-width:600px;border-collapse:collapse;">
          ...
          <tr>
            <td style="background-color:#ffffff;padding:40px;border-radius:0 0 16px 16px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
              ...
              <p style="margin:0 0 16px;color:#52525b;font-size:16px;line-height:1.6;">
                Agradecemos enormemente tu participación como juez. Tu tiempo y experiencia son fundamentales para inspirar a las participantes.
              </p>
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const html = generateJudgeWelcomeHtml(name);
    ...
    const brevoRes = await fetch("https://api.brevo.com/v3/smtp/email", {
      ...
      body: JSON.stringify({
        ...
        subject: "Tu perfil de juez está listo — Technovation Girls Madrid",
        htmlContent: html,
      }),
    });
    ...
    console.log(`Judge welcome email sent to ${recipientEmail}`);
